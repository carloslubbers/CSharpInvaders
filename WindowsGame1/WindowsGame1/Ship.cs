...
{
    class Ship : Updatable, Drawable, Controllable
    {
        ...
        const String shipTextureName = "shipTexture";

        public Ship(SpriteBatch _spriteBatch, ContentManager _content, Viewport _viewport)
        {
